---
title: "Dangerous driving behavior"
output: 
  flexdashboard::flex_dashboard
runtime: shiny
---
```{r}
data<- read.csv("D:/BILAL/output_taxi.csv", sep = ",")
...
renderPlot({
 updateData() %>% 
  ggplot(aes(x=!! rlang::sym(input$GB),y=!! rlang::sym(input$Metric),fill=!! rlang::sym(input))) +
  geom_col()
})
```
